...
public class HttpRequestUtil {
     ...
     */
    public static String sendGet(String url, String param,HashMap<String,String> header,boolean isproxy) {
        String result = "";
    ...
    public static String sendPost(String url, String param,HashMap<String,String> header,boolean isproxy) {
        OutputStreamWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
    ...
    public static void main(String[] args) {
        //demo:代理访问
        String url = "http://127.0.0.1:7788/user/goto_login";
        String para = "{\n" +
                "\t\"username\":\"zs\",\n" +
                "\t\"password\":\"123\"\n" +
                "}";
